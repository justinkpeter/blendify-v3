...
export const Navbar = () => {
    ...
    return (
        <>
            <nav className={'fixed right-3 top-1.5 z-50 flex flex-grow text-white/90'} ref={scope}>
                <header>
                    <motion.div
                        onClick={() => setIsOpen(!isOpen)}
                        whileTap={{ scale: 0.97 }}
                        className={'flex space-x-3 opacity-90 hover:opacity-80 items-center text-white bg-black cursor-pointer rounded-full p-1 pr-4'}>
                        <img
                    ...
                    <ul
                        ...
                        className={'flex flex-col gap-2 bg-neutral cursor-pointer py-2 my-2  '}
                    >
